...
namespace equilog_backend.Migrations
{
    ...
    [Migration("20250402124148_InitManytoManyRelations2.0")]
    partial class InitManytoManyRelations20
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("equilog_backend.Models.UserEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("equilog_backend.Models.UserEvent", b =>
                {
                    b.HasOne("equilog_backend.Models.Event", "Event")
                        .WithMany("UserEvents")
